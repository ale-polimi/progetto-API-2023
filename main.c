...
void dijkstra(uint32_t **, int, int, int *, int);
 ...
 */
void dijkstra(uint32_t **graph, int src, int dest, int *lut, int numOfStations) {
...
/**
 * Funzione utilizzata per creare un grafo.
